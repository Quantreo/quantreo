...
=== "Example"
    ```python
    df["label"] = te.directional.quantile_label(df, col='returns', upper_quantile_level=0.67, lower_quantile_level=0.33)
    ```
...
=== "Function"
    ```python
    te.directional.triple_barrier_labeling(df: pd.DataFrame, max_duration_h: float, open_col: str = "open", 
        high_col: str = "high", low_col: str = "low", high_time_col: str = "high_time", low_time_col: str = "low_time",
