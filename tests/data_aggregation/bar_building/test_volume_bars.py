import numpy as np
import pandas as pd
from quantreo.data_aggregation.bar_building.volume_bars import ticks_to_volume_bars


def test_ticks_to_volume_bars(ticks_sample):
    """Test the ticks_to_volume_bars function."""
    df = ticks_sample.copy()

    # === Basic functional call ===
    bars = ticks_to_volume_bars(df, volume_per_bar=5_000)
    ...
    df_original = df.copy()
    ticks_to_volume_bars(df_original, volume_per_bar=1_000_000)
