import numpy as np
import pandas as pd
from quantreo.data_aggregation.bar_building.volume_imbalance_bars import ticks_to_volume_imbalance_bars


def test_ticks_to_volume_imbalance_bars(ticks_sample):
    """Test the ticks_to_volume_imbalance_bars function."""
    df = ticks_sample.copy()

    # === Basic functional call ===
    bars = ticks_to_volume_imbalance_bars(df, expected_imbalance=10)
    ...
    df_original = df.copy()
    ticks_to_volume_imbalance_bars(df_original, expected_imbalance=500_000)
